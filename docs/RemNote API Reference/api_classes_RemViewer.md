<!-- source: https://plugins.remnote.com/api/classes/RemViewer -->
...
-   `Component`<[`RemViewerProps`](/api/interfaces/RemViewerProps)\>
...
[`RemViewerProps`](/api/interfaces/RemViewerProps) | `Readonly`<[`RemViewerProps`](/api/interfaces/RemViewerProps)\>

#### Inherited from[​](#inherited-from "Direct link to heading")

React.Component<RemViewerProps\>.constructor

• **new RemViewer**(`props`, `context`)
