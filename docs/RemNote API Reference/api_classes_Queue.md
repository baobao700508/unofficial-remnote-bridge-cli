<!-- source: https://plugins.remnote.com/api/classes/Queue -->
...
-   `Component`<[`QueueProps`](/api/interfaces/QueueProps)\>
...
[`QueueProps`](/api/interfaces/QueueProps) | `Readonly`<[`QueueProps`](/api/interfaces/QueueProps)\>

#### Inherited from[​](#inherited-from "Direct link to heading")

React.Component<QueueProps\>.constructor

• **new Queue**(`props`, `context`)
