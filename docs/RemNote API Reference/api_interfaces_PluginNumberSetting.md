<!-- source: https://plugins.remnote.com/api/interfaces/PluginNumberSetting -->
...
• `Optional` **validators**: [`NumberValidatorArray`](/api/modules#numbervalidatorarray)