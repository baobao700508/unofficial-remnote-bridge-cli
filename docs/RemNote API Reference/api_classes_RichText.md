<!-- source: https://plugins.remnote.com/api/classes/RichText -->
...
-   `Component`<[`RichTextProps`](/api/interfaces/RichTextProps)\>
...
[`RichTextProps`](/api/interfaces/RichTextProps) | `Readonly`<[`RichTextProps`](/api/interfaces/RichTextProps)\>
