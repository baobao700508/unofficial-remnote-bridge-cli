<!-- source: https://plugins.remnote.com/api/interfaces/PluginStringSetting -->
...
### multiline[​](#multiline "Direct link to heading")
...
• `Optional` **validators**: [`StringValidatorArray`](/api/modules#stringvalidatorarray)