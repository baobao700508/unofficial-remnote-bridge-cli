...
node "/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
