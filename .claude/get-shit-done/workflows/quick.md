...
```bash
INIT=$(node "/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
