...
- **Global scope**: `/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/notes/`)
...
2. Glob `/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jinliangjian/Desktop/所有的项目/开发项目/remnote-bridge cli/.claude/notes/` — works in any directory
